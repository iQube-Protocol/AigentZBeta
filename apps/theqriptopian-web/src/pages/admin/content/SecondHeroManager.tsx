...
export default function SecondHeroManager() {
  ...
  const loadContent = async () => {
    try {
      const data = await contentService.getAllContentBySection('second-hero');
      setContent(data);
    } catch (error) {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-4xl font-bold text-foreground">Second Hero</h1>
            <p className="text-muted-foreground mt-1">
              Manage bottom featured article
            </p>
          </div>
          <Button onClick={() => navigate('/admin/content/edit/new?section=second-hero')}>
        ...
        {content.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Create your second hero article to get started
            </p>
            <Button onClick={() => navigate('/admin/content/edit/new?section=second-hero')}>
              <Plus className="h-4 w-4 mr-2" />
              Create Article
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => navigate(`/admin/content/edit/${item.id}?section=second-hero`)}
                      >
