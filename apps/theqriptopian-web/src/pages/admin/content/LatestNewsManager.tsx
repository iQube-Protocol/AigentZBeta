...
export default function LatestNewsManager() {
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground mt-1">
              Manage news carousel articles
            </p>
          </div>
          <Button onClick={() => navigate('/admin/content/edit/new?section=latest-news')}>
        ...
        {content.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Create your first latest news article to get started
            </p>
            <Button onClick={() => navigate('/admin/content/edit/new?section=latest-news')}>
              <Plus className="h-4 w-4 mr-2" />
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => navigate(`/admin/content/edit/${item.id}?section=latest-news`)}
                      >
