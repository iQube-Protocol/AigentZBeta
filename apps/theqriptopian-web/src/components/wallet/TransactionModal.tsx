...
export function TransactionModal({
  ...
  const [selectedDeliveryMode, setSelectedDeliveryMode] = useState<DeliveryMode>(deliveryMode);
  ...
  }, [isOpen, initialTab, prefillRecipient, prefillAmount, prefillTxHash, prefillChainId]);
