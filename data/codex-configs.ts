  ...
  tabs: [
    {
      ...
      order: 0,
      type: 'static',
      config: { component: 'AgentiqOSHomeTab', props: {} },
      metadata: { icon: 'Home', description: 'Start Here and Aigent C overview' },
    },
    {
      id: 'agentiq-os-bind',
      label: 'Bind',
      ...
      order: 1,
      type: 'static',
      config: { component: 'AgentiqOSBindTab', props: {} },
      metadata: { icon: 'Link', description: 'Create your developer persona and grant bounded delegation' },
    },
    {
      id: 'agentiq-os-build',
      label: 'Build',
      ...
      order: 2,
      type: 'static',
      config: { component: 'AgentiqOSBuildTab', props: {} },
      metadata: { icon: 'Code', description: 'SDK, SmartTriad, Liquid UI, Runtime and Studio reference' },
    },
    {
      id: 'agentiq-os-deploy',
      label: 'Deploy',
      slug: 'deploy',
      enabled: true,
      order: 3,
      type: 'static',
      config: { component: 'AgentiqOSDeployTab', props: {} },
      metadata: { icon: 'Rocket', description: 'Build dashboard, ingestion factory, codex, and nanOS bridge' },
    },
    {
      id: 'agentiq-os-mission-boards',
      label: 'Mission Boards',
      slug: 'mission-boards',
      enabled: true,
      order: 4,
      type: 'static',
      config: { component: 'DevMissionBoardTab', props: {} },
      metadata: { icon: 'Target', description: 'Developer missions and KNYT Wheel reference board' },
    },
    {
      id: 'agentiq-os-community',
      label: 'Community',
      slug: 'community',
      enabled: true,
      order: 5,
      type: 'static',
      config: { component: 'AgentiqOSCommunityTab', props: {} },
      metadata: { icon: 'Users', description: 'Dev resources, platform updates, and Qriptopian editorial' },
    },
    {
      ...
      metadata: { icon: 'BookOpen', description: 'Protocol reference, stack overview, identity sovereignty, developer standards' },
    },
  ],
  permissions: {
    view: ['*'],
