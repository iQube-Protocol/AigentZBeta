  ...
  tabs: [
    {
      ...
      metadata: { icon: 'Home', description: 'Welcome and quick-start guide' },
    },
    {
      ...
      metadata: { icon: 'BookOpen', description: 'Protocol reference, stack overview, developer standards' },
    },
    {
      ...
      metadata: { icon: 'Bot', description: 'Aigent C-OS — your developer AI guide' },
    },
    {
    ...
    },
    {
      ...
      metadata: { icon: 'Shield', description: 'Grant bounded authority to Aigent C-OS; audit log' },
    },
    {
      id: 'agentiq-os-build',
      label: 'Build',
      ...
      metadata: { icon: 'Layers', description: 'Live AgentiQ OS dashboard — registry and factory pipeline' },
    },
    {
      id: 'agentiq-os-registry',
      label: 'Registry',
      slug: 'registry',
      enabled: true,
      order: 6,
    ...
    },
    {
      ...
      metadata: { icon: 'MessageSquare', description: 'SmartTriad copilot layer interfaces' },
    },
    {
      ...
      metadata: { icon: 'Layout', description: 'Liquid UI component contracts' },
    },
    {
      ...
      metadata: { icon: 'Code', description: 'SDK install and quickstart' },
    },
    {
      id: 'agentiq-os-missions',
      label: 'Missions',
      slug: 'missions',
      enabled: true,
      order: 12,
      type: 'static',
      config: { component: 'DevMissionBoardTab', props: {} },
      metadata: { icon: 'Target', description: 'Developer onboarding mission board' },
    },
    {
      ...
      metadata: { icon: 'GitBranch', description: 'AgentiQ OS vs nanOS comparison' },
    },
    {
      ...
      metadata: { icon: 'BookMarked', description: 'SDK docs, GitHub, Discord, video tutorials' },
    },
    {
      id: 'agentiq-os-qriptopian-news',
      label: 'Qriptopian News',
      slug: 'qriptopian-news',
      enabled: true,
      order: 15,
      type: 'static',
      config: { component: 'FeaturesTab', props: {} },
      metadata: { icon: 'Newspaper', description: 'Latest editorial from the Qriptopian' },
    },
    {
      id: 'agentiq-os-codex',
      label: 'AgentiQ OS Codex',
      slug: 'agentiq-os-codex',
      enabled: true,
      order: 16,
      type: 'static',
      config: { component: 'AgentiqCartridgeTab', props: { packId: 'agentiq-os', collectionId: 'col_codex' } },
      metadata: { icon: 'BookMarked', description: 'Canonical asset types and codex model' },
    },
  ],
  permissions: {
    view: ['*'],
