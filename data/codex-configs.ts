...
export const MARKETA_CARTRIDGE: CodexConfig = {
  ...
  tabs: [
    // ── Admin tabs (operator + Marketa agent) ─────────────────────────────
    {
      ...
      metadata: { icon: 'BarChart3', description: 'Live 3-cohort campaign overview', color: 'rose' },
    },
    {
      ...
      metadata: { icon: 'Target', description: 'KS, KNYT Codex, and Partner campaign command centre', color: 'rose' },
    },
    {
      id: 'marketa-partners',
      label: 'Partners',
      ...
      metadata: { icon: 'Users', description: 'AVL partner pipeline, Wave activation, and outreach', color: 'violet' },
    },
    {
      ...
      metadata: { icon: 'CheckSquare', description: 'Review and approve partner-proposed campaign packs', color: 'amber' },
    },
    {
      id: 'marketa-qubetalk-admin',
      label: 'QubeTalk',
      slug: 'marketa-qubetalk-admin',
      enabled: true,
      adminOnly: true,
      order: 5,
      type: 'static',
      config: { component: 'MarketaTab', props: { defaultTab: 'qubetalk' } },
      metadata: { icon: 'MessageSquare', description: 'Agent coordination and partner comms', color: 'rose' },
    },
    // ── Partner tabs (role-gated to avl_partner_contacts identity) ────────
    {
      id: 'my-campaign',
      label: 'My Campaign',
      slug: 'my-campaign',
      ...
      metadata: { icon: 'Megaphone', description: 'Your invited campaign — join, select channels, confirm participation', color: 'rose' },
    },
    {
      id: 'propose-campaign',
      ...
      metadata: { icon: 'Sparkles', description: 'Propose a campaign — Marketa AI builds your pack for approval', color: 'amber' },
    },
    {
      id: 'my-packs',
      label: 'My Packs',
      ...
      metadata: { icon: 'Package', description: 'Your approved campaign packs — publish to your channels', color: 'rose' },
    },
    {
      id: 'partner-qubetalk',
      label: 'QubeTalk',
      ...
      type: 'static',
      config: { component: 'MarketaTab', props: { defaultTab: 'qubetalk' } },
      metadata: { icon: 'MessageSquare', description: 'Communicate with Marketa and the venture studio team', color: 'rose' },
    },
  ],
  permissions: {
    view: ['*'],
