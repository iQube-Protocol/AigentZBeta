...
export const HUMAN_MOBILITY_SERVICES_CARTRIDGE: CodexConfig = {
  ...
  tabGroups: [
    ...
    { id: 'activations', label: 'Activations', icon: 'Target',        order: 2, adminOnly: true },
    { id: 'housing',     label: 'Housing',     icon: 'Home',          order: 3, adminOnly: true },
    { id: 'education',   label: 'Education',   icon: 'GraduationCap', order: 4, adminOnly: true },
    { id: 'relocation',  label: 'Relocation',  icon: 'Package',       order: 5, adminOnly: true },
    { id: 'business',    label: 'Business',    icon: 'Briefcase',     order: 6, adminOnly: true },
    { id: 'economic',    label: 'Economic',    icon: 'TrendingUp',    order: 7, adminOnly: true },
    { id: 'family',      label: 'Family',      icon: 'Heart',         order: 8, adminOnly: true },
  ],
  tabs: [
    {
      id: 'hms-activation',
