...
import { idlFactory } from './reward_hub.did.js';
export { idlFactory } from './reward_hub.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REWARD_HUB;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reward_hub.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reward_hub canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reward_hub.did.js")._SERVICE>}
 */
export const reward_hub = createActor(canisterId);
