...
import { idlFactory } from './rqh.did.js';
export { idlFactory } from './rqh.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RQH;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rqh.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rqh canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rqh.did.js")._SERVICE>}
 */
export const rqh = createActor(canisterId);
