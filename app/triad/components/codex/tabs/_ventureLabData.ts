...
export const SAMPLE_VENTURES: Array<Omit<Venture, 'id' | 'status'>> = [
  {
    ...
    payload: {
      ...
      key_milestones: ['13 character NFTs launched','Kickstarter campaign live','KNYT Wheel in build','MVL partner wave activating'],
      next_steps: ['Close KS — target 200+ backers','Activate 16 Wave 1 MVL partners','Launch collector packs post-campaign'],
