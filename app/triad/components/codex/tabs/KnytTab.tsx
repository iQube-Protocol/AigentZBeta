...
const KNYT_CONTENT_CACHE_KEY = "codex:knyt:content:v10";
const KNYT_EPISODES_CACHE_KEY = "codex:knyt:episodes:v8";
const KNYT_SESSION_CACHE_KEY = "codex:knyt:session:v8";
