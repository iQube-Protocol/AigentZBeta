...
const SELECT_COLS =
  'passport_id, passport_class, citizen_status, participant_status, passport_grade, kybe_did_public_ref, root_did_public_ref, persona_public_ref, registry_record_id, issuer_id, issued_at, expires_at, revoked, credential_claimed_at, persona_id, renewal_of_passport_id';
const SELECT_COLS_LEGACY =
  'passport_id, passport_class, citizen_status, participant_status, passport_grade, kybe_did_public_ref, root_did_public_ref, persona_public_ref, registry_record_id, issuer_id, issued_at, expires_at, revoked, persona_id, renewal_of_passport_id';
