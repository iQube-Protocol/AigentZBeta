/**
 * POST /api/assistant/draft-slides
 * Aigent Me Phase 6.b Part 2.5c — Slides drafter.
 */
...
import { draftSlideOutline, type DraftSlideContext } from '@/services/agents/draftSlideOutline';
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const draft = await draftSlideOutline({ prompt, context: ctx });
