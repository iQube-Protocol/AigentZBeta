    ...
    return NextResponse.json(
      {
        ...
        workflow: claimed
          ...
          : [
              ...
              'HUMAN ACT (OPTIONAL): your principal grants you bounded delegation (Delegation tab) — required only if YOU will administer access/experiments on their behalf; a citizen proceeding themselves may skip this',
