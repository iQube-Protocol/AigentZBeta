...
import exp001Run1 from '@/codexes/packs/agentiq/foundation/experiments/exp-001-living-knowledgeqube/evaluation-results-2026-07-04.json';
import exp003Run1 from '@/codexes/packs/agentiq/foundation/experiments/exp-003-rediscovery-savings/results-2026-07-04.json';
import exp002Run2 from '@/codexes/packs/agentiq/foundation/experiments/exp-002-invariant-video/run2-results-2026-07-05.json';
