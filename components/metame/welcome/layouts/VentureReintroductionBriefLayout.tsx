...
/**
 * VentureReintroductionBriefLayout — Phase 2 Slice 6 (Deliberation).
 *
 * Right-pane workspace for assembling a venture reintroduction brief.
 * Extends VentureReportBriefLayout with fields for audience, prior understanding,
 * and reintroduction goals.
 *
 * DIS template id: `venture-reintroduction-brief-layout-v1`.
 */
...
interface VentureReintroductionBriefLayoutProps extends RightPaneLayoutProps {
...
function VentureReintroductionBriefLayoutComponent(
  props: VentureReintroductionBriefLayoutProps
) {
  const {
    theme = "dark",
    deliberationBrief,
  ...
  const spec = deliberationBrief?.briefSpec as VentureReintroductionBriefSpec | undefined;
  ...
  return (
    <LayoutShell
      surfaceId="venture-reintroduction-brief"
      disTemplateId="venture-reintroduction-brief-layout-v1"
      theme={theme}
      headerIcon={<Users className="h-3.5 w-3.5" />}
      headerEyebrow="Deliberation"
      headerTitle="Venture Reintroduction Brief"
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  >
                    {isComplete
                      ? "All required fields are set. You can generate the reintroduction now."
            ...
            >
              ...
              <div className="space-y-2">
                ...
                {editingField === "audience" ? (
                  ...
                  <button
                    onClick={() => handleEditField("audience", spec?.audience || "")}
                  ...
                  >
                    <span>{spec?.audience || "Not set"}</span>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  value={spec?.reintroductionGoal || ""}
                  onChange={(e) =>
                    onUpdateBriefSpec?.({
                      reintroductionGoal: e.target.value || undefined,
                    })
                  }
                  placeholder="What should they understand or do after this reintroduction?"
              ...
              <div className="space-y-2">
                ...
                <input
                  type="date"
                  value={spec?.lastInteraction || ""}
                  onChange={(e) =>
                    onUpdateBriefSpec?.({
                      lastInteraction: e.target.value || undefined,
                    })
                  }
                  className={`w-full text-sm px-3 py-2 rounded border ${
                    isDark
              ...
              <div className="space-y-2">
                ...
                <select
                  value={spec?.priorUnderstandingSource || ""}
                  onChange={(e) =>
                    onUpdateBriefSpec?.({
                      priorUnderstandingSource: e.target.value || undefined,
                    })
                  }
                  className={`w-full text-sm px-3 py-2 rounded border ${
                    isDark
                ...
                >
                  ...
                  <option value="explicit_previous_report">Explicit previous report</option>
                  <option value="known_last_interaction">Known last interaction</option>
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h3 className="text-sm font-semibold mb-1">
            Assembling reintroduction brief
          </h3>
          <p className={`text-xs leading-relaxed ${muted}`}>
            AigentMe is gathering evidence and preparing the deliberation workspace
            for your reintroduction.
          </p>
        </div>
      </div>
    </div>
...
export const VentureReintroductionBriefLayout: RightPaneLayoutDefinition = {
  id: "venture-reintroduction-brief",
  label: "Venture Reintroduction Brief",
  component: VentureReintroductionBriefLayoutComponent,
  disTemplateId: "venture-reintroduction-brief-layout-v1",
};
