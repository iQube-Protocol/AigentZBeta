...
import { Mail, Calendar, FileText, Sheet, Layout, Megaphone } from "lucide-react";
...
export function ComposeQuickActionsStrip({ onOpen, theme = "dark" }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 px-3 py-2">
      <span className={`text-[10px] uppercase tracking-wider mr-1 ${isDark ? "text-slate-500" : "text-slate-500"}`}>
        Compose
      </span>
