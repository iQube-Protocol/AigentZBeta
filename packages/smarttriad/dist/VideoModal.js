...
export function VideoModal({ isOpen, onClose, items, initialIndex = 0 }) {
    ...
    return (_jsx("div", { className: "fixed inset-0 z-[200] bg-black/95 flex items-center justify-center", children: _jsxs("div", { className: "relative w-full h-full flex items-center justify-center", children: [_jsx("video", { ref: videoRef, src: currentItem.videoUrl, className: "max-w-full max-h-full object-contain", autoPlay: true, controls: true }), _jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2", children: _jsxs("span", { className: "text-cyan-400 text-sm", children: ["Duration: ", currentItem.duration || "0:00"] }) }), _jsxs("div", { className: "absolute top-4 right-4 flex flex-col gap-2 z-[210]", children: [_jsx("button", { onClick: (e) => {
                                e.stopPropagation();
                                onClose();
                            }, className: "w-10 h-10 rounded-full bg-gray-800/80 hover:bg-gray-700 flex items-center justify-center text-white transition-colors", "aria-label": "Close video", children: _jsx(X, { className: "h-5 w-5" }) }), _jsx("button", { onClick: (e) => {
                                e.stopPropagation();
                                handleReplay();
                            }, className: "w-10 h-10 rounded-full bg-gray-800/80 hover:bg-gray-700 flex items-center justify-center text-white transition-colors", "aria-label": "Replay video", children: _jsx(RotateCcw, { className: "h-5 w-5" }) })] }), items.length > 1 && (_jsxs(_Fragment, { children: [_jsx("button", { onClick: (e) => {
                                e.stopPropagation();
                                handlePrev();
