...
> **Formerly designated EXP-P2.** Renumbered **EXP-011** on 2026-07-27, when the EXP-P2
> designation was reserved for the foundational **Consequential Performance** experiment.
> References created before 2026-07-27 may use the former designation and remain correct as
> historical record — including EXP-P1 §14, whose "EXP-P2" cross-reference resolves to THIS
> document. The designation moved; the design, its hypothesis class, its governing invariants,
> and its runner did not.
>
> Numbers are never reused: EXP-011 is the next free value in the EXP-0NN sequence, not a
> recycled one. This experiment remains registered in the Laboratory under the **SCS —
> Structural & Capability Studies** series, with its harness bound to EXP-011.
