...
| A10 | **Canonical Invariants (seed crystal)** — 141 statements across 12 namespaces | `codexes/packs/irl/foundation/canonical-invariants.seed.json`; substrate `services/invariants/store.ts` → tables `invariants`, `invariant_contexts`, `invariant_edges`, `ontology_classes` | ✅ |
