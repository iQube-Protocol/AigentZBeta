...
| 1.5 | Constitutional primitives: Identity | **I** | Identity spine: `services/identity/getActivePersona.ts`, persona/delegate model, T0/T1/T2 tiers, canary tests. | Identity *continuity across models* is F (IRL-010 Part VII). |
...
| Identity continuity across model substitutions | Implied by sovereignty narrative | Planned (IRL-010 Part VII) |
