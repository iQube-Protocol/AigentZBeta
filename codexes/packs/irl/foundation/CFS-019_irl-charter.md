...
**First named instance: Financial Services** (`CRP-003`, chartered 2026-07-15) — five domains (Treasury Operations, Trading Orchestration, Financial Intelligence, Constitutional Financial Integrity, Constitutional Commerce), each mapped to a core constitutional primitive (Bounded Delegation, Standing, Evidence) rather than a generic financial-workflow category. **Ratified 2026-07-15 by operator direction.**
