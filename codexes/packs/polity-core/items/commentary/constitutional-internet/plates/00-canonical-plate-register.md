---
title: "Constitutional Internet Canonical Plates — Register"
register_id: "CIP-REGISTER-V1"
series: "The Constitutional Internet"
canon_status: "ratified"
status: "active"
artifact_class: "canonical constitutional commentary"
ratified_at: "2026-08-10"
namespace: "CIP"
namespace_note: "CIP is the Constitutional Internet plate namespace and is distinct from the CFS-027 Invariant Intelligence CP-001..CP-007 plate system."
bridge_relevance:
  - "Constitutional Internet Bridge / View"
  - "Constitutional Internet Bridge / Orient"
  - "Constitutional Internet Bridge / video planning"
machine_manifest: "docs/constitutional-plates/constitutional-internet.v1.json"
---
...
| ID | Plate | Status | Primary bridge role |
|---|---|---|---|
| **CIP-003A** | Canonical MetaVitruvian — Male Rendering | Ratified | View |
| **CIP-003B** | Canonical MetaVitruvian — Female Rendering | Ratified | View |
...
A plate is not decorative media. It is a compressed constitutional argument. Its use must preserve the plate's source lineage, evidence state, and status language. A rendering must not visually strengthen an implementation claim beyond what the underlying doctrine and evidence support.

For the Constitutional Internet Bridge, the intended grammar is:

> **Video creates consciousness. Plate creates comprehension. Prose creates depth. Ritual creates state. Choice creates demand. Sharing proliferates the field.**

The current working use is to compose these plates principally within the **View** stage, with selective reuse in **Orient** where a plate makes the next constitutional act more intelligible. Exact placement is a bridge-composition decision and is not fixed by canonization.
