...
| **R-14** | The B¢ **allocation schedule** — how the 100,000,000 premine splits across purposes (item 7 of the freeze list). **Proposed, not ratified, 2026-07-30:** 35% settlement liquidity/market-making, 25% service-economy reserve, 15% ecosystem incentives, 10% operational settlement reserve, 10% treasury/contingency, 5% future governed distribution — sums to the 100,000,000 premine without reopening that amount. Recorded in `scripts/bitcent-issuance-record.json` as `allocationSchedule.proposed`, `ratified: false`. | the etch itself |
| **R-15** | **Issuer/holder of the B¢ premine** (item 8 of the freeze list). **Policy ratified 2026-07-30, wallet not yet provisioned:** Aigent Z is the operational treasury custodian (not MoneyPenny — FS Runtime orchestrator, may route liquidity but not control the reserve; not Aigent Nakamoto — Bitcoin issuance-integrity/governance overseer with approval/veto authority, not the treasury holder). Still blocking ratification: a real, dedicated multisig/threshold "Aigent Z BitCent Treasury" wallet (never single-key), spending-limit/approval policy, recovery/rotation procedure, DVN receipts per movement, independent reconciliation, Aigent Nakamoto oversight wiring. None of this infrastructure exists yet — separate, larger engineering work than the script consolidation. | the etch itself |
