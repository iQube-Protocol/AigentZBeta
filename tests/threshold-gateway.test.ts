...
// Same chain, a SECOND edge (2026-08-28): constitutionalNavigator.ts also
// imports services/journey/boundaryResearchExchangeAdmission.ts, which now
// imports services/access/requireCartridgeAdmin.ts for its operator-assisted
// admission wrapper. That module's OTHER export (requireCartridgeAdmin)
// imports getActivePersona.ts -> multiEmailIdentity.ts, the identical
// module-evaluation-time createClient() failure the mock above already
// exists to prevent for the first edge.
