-- 20261001000800_factor_selection_proposed_receipt_type.sql
--
...
--
--   'factor_selection_proposed' — Use Case Zero build-order item 7
--   (2026-09-13, services/factor/factorSelectionArtifact.ts). Factor's
--   candidate-selection proposal: Factor discovers a candidate agent/
--   service/counterparty against the REGISTRABLE_AGENTS registry
--   (services/horizen/registrableAgents.ts) and proposes it, carrying only
...
--   future receipt types). DVN-anchorable
--   (services/dvn/activityReceiptDvnPipeline.ts).
--
-- Carried forward VERBATIM from
-- 20261001000700_vela_underwriting_projection_receipt_type.sql plus exactly
