-- ============================================================================
-- AVL Comms Packs v2 — Updated copy + new Partner Invite pack
--
-- Updates the two existing packs with the finalised Dele Atanda / metaProof
-- copy and adds a third pack for warm/existing-relationship partners.
--
-- Template variables:
--   {{partner.first_name}}  — First name only (extracted from contact_name)
--   {{partner.name}}        — Organisation name
--   [text](url)             — Rendered as <a href="url"> in HTML email
-- ============================================================================
...
(
  ...
  '[{"label": "KS Campaign", "url": "https://www.kickstarter.com/projects/metaproof/metaknyt-the-agentic-graphic-novel"}, {"label": "The Qriptopian", "url": "https://qriptopia.com"}]',
