-- Polity Passport Bureau — extend activity_receipts.action_type CHECK with
-- the six passport receipt types (DVN-anchorable; mirrors the
...
--
-- Additive: re-creates the CHECK with the original nine types plus passport.
