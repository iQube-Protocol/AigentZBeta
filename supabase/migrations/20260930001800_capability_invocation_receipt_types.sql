-- 20260806000000_capability_invocation_receipt_types.sql
--
-- Governed Capability Invocation (Phase 4 of the Agent Bench / aigentMe
-- Specialist Orchestration brief, 2026-08-06). Wholesale CHECK-constraint
...
--
-- See services/registry/invocationGateway.ts::invokeCapability and
