...
Status: direct deployment authorized by the operator on 2026-09-01. Code deployment precedes the guarded data repair; live acceptance is recorded separately.
...
Operator explicitly superseded the QubeTalk route: Codex deploys directly to dev. No relay is required.
