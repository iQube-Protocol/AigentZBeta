...
function sampleTemplates(): IQubeTemplate[] {
  return [
    {
      id: "aigentqube-aigent-z",
      name: "Aigent Z",
      description: "The system orchestrator for the AgentiQ OS. Routes all interactions, enforces metaMe policy, selects NBE dispositions, and coordinates the agent trio.",
    ...
    },
    {
      id: "aigentqube-kn0w1",
      name: "Kn0w1",
      description: "Lead intelligence surface of the KNYT cartridge. Explains treasury, rewards, Qc vs $KNYT, and personal progression.",
      createdAt: "2026-04-14T00:00:00Z",
      iQubeType: 'AigentQube',
      iQubeInstanceType: 'instance',
      businessModel: 'Subscribe',
    ...
    {
      id: "aigentqube-marketa",
      name: "Marketa",
      description: "Campaign and CRM intelligence agent. Manages investor relations, campaign sequencing, and Kickstarter backer cohort tracking.",
      createdAt: "2026-04-14T00:00:00Z",
      iQubeType: 'AigentQube',
      iQubeInstanceType: 'instance',
      businessModel: 'Subscribe',
