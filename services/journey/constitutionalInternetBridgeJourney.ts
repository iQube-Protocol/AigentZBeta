...
export const CONSTITUTIONAL_INTERNET_BRIDGE_JOURNEY: JourneyDefinition = {
  ...
  stages: [
    ...
    //    connection) — the CI on-ramp into the Financial Services Bridge,
    //    same grammar as knytsBridgeCrossingJourney.ts's segment, indigo
    //    preset instead of amber. Gate-less like HOME/VIEW/ORIENT/CHOOSE.
    {
      id: 'fs-discover',
      label: 'Discover',
